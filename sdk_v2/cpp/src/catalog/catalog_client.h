...
/// - `filter_override` overrides the deployment-option filter (default `Foundry Local on Devices`).
/// - `catalog_region` optionally supplies model-registry routing metadata for downloads.
