...
class AzureCatalogClient : public ICatalogClient {
 public:
  ...
  /// per-device search with `labels=latest` removed, then filtering by alias locally.
  /// `model_alias` must be non-empty. Optionally filters by `model_name` server-side.
