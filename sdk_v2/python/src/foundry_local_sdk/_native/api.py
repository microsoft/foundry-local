...
# FOUNDRY_LOCAL_API_VERSION = 2 (from foundry_local_c.h). Also the version stamped on every
# versioned struct this package builds, so the two can never disagree.
