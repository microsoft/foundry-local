...
const describeIfPreload = havePreloadAddon ? describe : describe.skip;
...
describeIfPreload("foundry_local_preload addon", () => {
  const require = createRequire(import.meta.url);
  const addon = require(preloadAddonPath) as PreloadAddon;
